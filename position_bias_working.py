# Enhanced position_bias_working.py with bootstrap integration
"""Statistical analysis module for position bias detection with bootstrap confidence intervals."""
...
def enhanced_analyze_position_bias(
    ...
    def chi_square_statistic(position_data):
        ...
        # position_data should be array of position indices
...
def run_enhanced_position_bias_analysis(questions: List[Question], **kwargs) -> Dict[str, Any]:
    """CLI integration function for enhanced position bias analysis with bootstrap."""
    report = enhanced_analyze_position_bias(questions, **kwargs)
    return _serialize_bootstrap_report(report)


def run_position_bias_analysis(questions: List[Question], **kwargs) -> Dict[str, Any]:
    """Original CLI integration function for backward compatibility."""
    # Remove bootstrap-specific kwargs for original function
    ...
    if 'n_bootstrap' in kwargs:
        # Use enhanced version with bootstrap
        return run_enhanced_position_bias_analysis(questions, **kwargs)
    else:
        # Use original version
        from position_bias_working import analyze_position_bias
        report = analyze_position_bias(questions, **original_kwargs)
